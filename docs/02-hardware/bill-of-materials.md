...
| INMP441*                | Digital I2S MEMS microphone                | <img src="/docs/08-assets/components/inmp441.png" width="100" height="100">            | 1        | Preferably get the version with pre-soldered header pins. To get these, I recommend you order it from [Microscale]([../04-backend/deployment-guide.md](https://www.microscale.net/products/inmp441-omnidirectional-microphone-module?_pos=1&_sid=2cc91557d&_ss=r))                                                    |
...
| 470uF Capacitor*      |         | <img src="/docs/08-assets/components/470uF capacitor.webp" width="100" height="100"> | 1 |                                               |
