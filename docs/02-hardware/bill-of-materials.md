...
| ---------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------- | -------- | ------------------------------------------------------------------------------------- |
| ESP32 DevKitC          | Main embedded controller                   | <img src="url" width="100" height="100">             | 1        | ESP32-WROOM-32D was used in this project, primarily because of innate I2S support     |
| INMP441                | Digital I2S MEMS microphone                | <img src="docs/08-assets/components/inmp441.png" width="100" height="100">            | 1        | Preferably get the version with pre-soldered header pins                              |
...
| 18650 Cells            | Battery cells used in battery assembly     | <img src="docs/08-assets/components/18650.webp" width="100" height="100">             | 2        | Used in parallel battery, 3.7V configuration                                                |
...
| MT3608 Boost Converter | Voltage step-up converter                  | <img src="docs/08-assets/components/mt3608.webp" width="100" height="100">            | 1        | Used for regulated voltage supply                                                     |
...
| Vero Board             | Prototype circuit mounting board           | <img src="docs/08-assets/components/veroboard.webp" width="100" height="100">         | 1        | Small dotted Vero board used for prototyping                                          |
| Female Pin Headers     | Modular pin connections                    | <img src="docs/08-assets/components/pin-headers.webp" width="100" height="100">       | Multiple | Bent headers were also utilized                                                       |
| Jumper Wires           | Interconnections between modules           | <img src="docs/08-assets/components/jumper-wires.webp" width="100" height="100">      | Multiple | Includes male-female and female-female jumper wires                                   |
| Hook-up Wires          | Power and signal wiring                    | <img src="docs/08-assets/components/wires.webp" width="100" height="100">             | Multiple | Recycled phone and PC wires were also utilized                                        |
| Spring Connectors      | Wire joining and modular connection        | <img src="docs/08-assets/components/spring-connectors.webp" width="100" height="100"> | Multiple | Useful for temporary secure connections                                               |
| Heat Shrink Tubing     | Electrical insulation and cable management | <img src="docs/08-assets/components/heatshrink.webp" width="100" height="100">        | Multiple | Used for battery and wire insulation                                                  |
| Velcro Strap           | Portable mounting system                   | <img src="docs/08-assets/components/velcro.webp" width="100" height="100">            | 1        | Used for wearable/portable deployment                                                 |
| Zip Ties               | Cable management and internal fastening    | <img src="docs/08-assets/components/zipties.webp" width="100" height="100">           | Multiple | Used for internal enclosure organization                                              |
...
| 3D Printed Enclosure   | Custom enclosure system                    | <img src="docs/08-assets/components/3d-enclosure.webp" width="100" height="100">      | 1        | Optional final enclosure design                                                       |
| Bag Material & Buckle  | Portable carrying/mounting accessory       | <img src="docs/08-assets/components/bag-material.webp" width="100" height="100">      | 1        | Used for wearable deployment concept                                                  |
| Soldering Lead         | Soldering material                         | <img src="docs/08-assets/components/solder.webp" width="100" height="100">            | Multiple | Used for permanent electrical connections                                             |
| Glue Sticks            | Hot glue application material              | <img src="docs/08-assets/components/glue-sticks.webp" width="100" height="100">       | Multiple | Used for internal fastening and insulation                                            |
